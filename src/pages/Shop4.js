...
import bottle from "../images/termiz.jpg"
...
function Shop() {
    ...
    return (
        <div>
            <Navbar />
            <div className='flex'>
                <img className='w-[900px] h-[900px] mx-[100px] border-2 border-black rounded my-[110px]' src={bottle} alt="" />
                ...
                <div className={style.sidebar}>
                    ...
                    <div className='translate-y-[40px]'>
                        <img className='w-[80px] h-[80px] translate-y-[40px]' src={bottle} alt="" />
